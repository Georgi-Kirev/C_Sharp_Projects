...
public class RepeatStringsTests
{
    ...
    {
        // Arrange
        string[] input = new string[] { "Car", "Bus", "Plane", "Boat", "Train" };
        string expected = "CarCarCarBusBusBusPlanePlanePlanePlanePlaneBoatBoatBoatBoatTrainTrainTrainTrainTrain";
